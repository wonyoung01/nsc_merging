...
if __name__ == "__main__":
    # Example usage
    ROOT = "./data/8vision/resisc45/NWPU-RESISC45-split/"
    train_dataset = RESISC45(root=ROOT, split="train")
    val_dataset = RESISC45(root=ROOT, split="val")
    test_dataset = RESISC45(root=ROOT, split="test")
    ipdb.set_trace()
